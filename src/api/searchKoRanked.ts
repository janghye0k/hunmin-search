 ...
 * For `editDistance` (including `null` on subsequence failures), use {@link searchKoDetailed} or {@link rankByKoPipeline}.
 *
 ...
 * 편집 거리·정렬 세부는 {@link searchKoDetailed} 또는 {@link rankByKoPipeline}을 사용하세요.
 *
 * @example
 ...
 * ```
 */
export function searchKoRanked(
  query: string,
  candidates: string[],
